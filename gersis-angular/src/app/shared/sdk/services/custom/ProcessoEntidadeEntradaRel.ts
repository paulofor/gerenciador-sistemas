...
/**
 * Api services for the `ProcessoEntidadeEntradaRel` model.
 */
@Injectable()
export class ProcessoEntidadeEntradaRelApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ProcessoEntidadeEntradaRel id
   *
   ...
   * This usually means the response is a `ProcessoEntidadeEntradaRel` object.)
   * </em>
   */
  public getEntidade(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProcessoEntidadeEntradaRels/:id/entidade";
  ...
  public getProcessoJava(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProcessoEntidadeEntradaRels/:id/processoJava";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PATCH";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProcessoEntidadeEntradaRels/:id";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {
   ...
   * </em>
   */
  public AtualizaPorProcessoEntrada(idProcesso: any = {}, lista: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProcessoEntidadeEntradaRels/atualizaPorProcessoEntrada";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
