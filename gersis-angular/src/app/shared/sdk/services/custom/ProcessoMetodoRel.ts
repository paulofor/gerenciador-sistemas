...
/**
 * Api services for the `ProcessoMetodoRel` model.
 */
@Injectable()
export class ProcessoMetodoRelApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ProcessoMetodoRel id
   *
  ...
  public getProcessoJava(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProcessoMetodoRels/:id/processoJava";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
