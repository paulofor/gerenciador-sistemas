...
/**
 * Api services for the `ProcessoEntidadeSaidaRel` model.
 */
@Injectable()
export class ProcessoEntidadeSaidaRelApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ProcessoEntidadeSaidaRel id
   *
  ...
  public getEntidade(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/ProcessoEntidadeSaidaRels/:id/entidade";
  ...
  public getProcessoJava(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProcessoEntidadeSaidaRels/:id/processoJava";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
