...
/**
 * Api services for the `LinuxInternet` model.
 */
@Injectable()
export class LinuxInternetApi extends BaseLoopBackApi {
  ...
  /**
   * processoJavas consultas de LinuxInternet.
   *
   * @param {any} id LinuxInternet id
   *
   * @param {object} filter 
  ...
  public getProcessoJavas(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LinuxInternets/:id/processoJavas";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * processoJavas contagens de LinuxInternet.
   *
   * @param {any} id LinuxInternet id
   *
  ...
  public countProcessoJavas(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LinuxInternets/:id/processoJavas/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
