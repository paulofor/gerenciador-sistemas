...
/**
 * Api services for the `ParametroMetodoServer` model.
 */
@Injectable()
export class ParametroMetodoServerApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ParametroMetodoServer id
   *
   ...
   * This usually means the response is a `ParametroMetodoServer` object.)
   * </em>
   */
  public getMetodoServer(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ParametroMetodoServers/:id/metodoServer";
